...
class Encoder(nn.Module):
    def __init__(self, nc: int = 256):
        ...
        self.pool4 = nn.AvgPool2d(4)  # 16 → 4
        self.to_nc = nn.Conv2d(128, nc, 1, bias=False)
...
class Decoder(nn.Module):
    def __init__(self, nc: int = 256, num_classes: int = 100):
        ...
        #     nn.ConvTranspose2d(nc, 128, 16, 16, bias=False),       # → (B,128,16,16)
        #     nn.BatchNorm2d(128),
        ...
        self.restore = nn.Sequential(
            ...
            # ---- Stage-1：1×1 → 4×4
            nn.ConvTranspose2d(
                in_channels=nc, out_channels=256,
